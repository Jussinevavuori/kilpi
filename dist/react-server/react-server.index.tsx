...
export type AccessProps<TSubject, TRuleset extends Ruleset<TSubject>, TKey extends RulesetKeys<TRuleset>> = {
	to: TKey;
...
export declare function createKilpiReactServer<TSubject, const TRuleset extends Ruleset<TSubject>>(Kilpi: KilpiServerInstance<TSubject, TRuleset, any>, globalOptions?: CreateKilpiReactServerOptions): {
	Access: <TKey extends RulesetKeys<TRuleset>>(props: AccessProps<TSubject, TRuleset, TKey>) => React$1.JSX.Element;
};
