...
// src/react-server/react-server.index.tsx
var exports_react_server_index = {};
__export(exports_react_server_index, {
  createKilpiReactServer: () => createKilpiReactServer
});
module.exports = __toCommonJS(exports_react_server_index);
var import_react = __toESM(require_react());
function createKilpiReactServer(Kilpi, globalOptions = {}) {
  async function AccessInner(props) {
  ...
  function AccessOuter(props) {
    const Loading = props.Loading === null ? null : props.Loading || globalOptions.defaultComponents?.Loading;
    if (props.suspense) {
      return /* @__PURE__ */ import_react.default.createElement(import_react.Suspense, {
        fallback: Loading
      }, /* @__PURE__ */ import_react.default.createElement(AccessInner, {
        ...props
      }));
    }
    return /* @__PURE__ */ import_react.default.createElement(AccessInner, {
      ...props
    });
  }
  return {
