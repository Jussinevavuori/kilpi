...
Using authorization objects allows for more a more feature-rich authorization system instead of simply returning a `boolean`.
...
To receive the authorization object, you can use the `Kilpi.getAuthorization` method.
