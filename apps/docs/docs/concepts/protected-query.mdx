...
You define protected queries with `Kilpi.query`. This is a simple example and you can [learn more about protecting queries](/docs/guides/protecting-queries) here to see how to **protect and redact data**.
...
<LinkCard 
  ...
  href="/docs/guides/protecting-queries"
/>
