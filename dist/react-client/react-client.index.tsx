...
declare function createClient<TSubject, const TRuleset extends Ruleset<TSubject>, TPlugin extends ReturnType<typeof createPlugin>>({ getSubject, rules, plugins, defaults, }: {
...
declare function createClient$1<TKilpi extends Pick<ReturnType<typeof createClient<any, any, any>>, "$$types">>(options: {
	secret: string;
	endpoint: string;
}): {
	getPermission: <TKey extends RulesetKeys<TKilpi["$$types"]["ruleset"]>>(key: TKey, resource: InferRuleResource<GetRuleByKey<TKilpi["$$types"]["ruleset"], TKey>>) => Promise<Permission<InferRuleSubjectNarrowed<GetRuleByKey<TKilpi["$$types"]["ruleset"], TKey>>>>;
	getSubject: () => Promise<TKilpi["$$types"]["subject"]>;
	invalidate: () => void;
	onInvalidate: (callback: () => void) => () => void;
	$$types: TKilpi["$$types"];
};
export type KilpiClientInstance<TSubject, TRuleset extends Ruleset<TSubject>, TPlugin extends KilpiPlugin> = ReturnType<typeof createClient$1<{
	$$types: {
		subject: TSubject;
		ruleset: TRuleset;
		plugins: TPlugin;
...
export type UsePermissionOptions<TSubject, TRuleset extends Ruleset<TSubject>, TKey extends RulesetKeys<TRuleset>> = {
	to: TKey;
	on: InferRuleResource<GetRuleByKey<TRuleset, TKey>>;
};
export type UsePermissionReturn<TSubject, TRuleset extends Ruleset<TSubject>, TKey extends RulesetKeys<TRuleset>> = {
	status: "loading";
} | {
	status: "denied";
	message?: string;
...
export type WithPermissionProps<TSubject, TRuleset extends Ruleset<TSubject>, TKey extends RulesetKeys<TRuleset>> = {
...
export type HasPermissionProps<TSubject, TRuleset extends Ruleset<TSubject>, TKey extends RulesetKeys<TRuleset>> = {
	children?: React.ReactNode;
	Loading?: React.ReactNode;
	Denied?: React.ReactNode;
	Error?: React.ReactNode;
} & UsePermissionOptions<TSubject, TRuleset, TKey>;
export declare function createKilpiReactClient<TSubject, const TRuleset extends Ruleset<TSubject>>(KilpiClient: KilpiClientInstance<TSubject, TRuleset, any>, globalOptions?: CreateKilpiReactClientOptions): {
	useSubject: () => UseSubjectReturn<TSubject>;
	usePermission: <TKey extends RulesetKeys<TRuleset>>(options: UsePermissionOptions<TSubject, TRuleset, TKey>) => UsePermissionReturn<TSubject, TRuleset, TKey>;
	HasPermission: <TKey extends RulesetKeys<TRuleset>>(props: HasPermissionProps<TSubject, TRuleset, TKey>) => import("react").ReactNode;
	WithPermission: <TKey_1 extends RulesetKeys<TRuleset>>(props: WithPermissionProps<TSubject, TRuleset, TKey_1>) => import("react").ReactNode;
};
