...
## The `@kilpi/react-server` package.

It contains the `ReactServerPlugin` for `Kilpi` from [`@kilpi/core`](https://www.npmjs.com/package/@kilpi/core) for RSC bindings of Kilpi, such as the `<Authorize />` component.
