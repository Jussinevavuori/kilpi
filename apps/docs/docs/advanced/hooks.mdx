---
title: Hooks
description: Learn about Kilpi's hooks system for advanced customization and event handling.
---
...
<Aside type="tip">
  Use the `KilpiClientCache.areCacheKeysEqual(keyA, keyB)` method to compare
  keys instead of `===`.
</Aside>
