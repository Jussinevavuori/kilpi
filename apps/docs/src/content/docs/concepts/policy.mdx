...
**A policy** is a function that receives a [**subject**](/concepts/subject) and optionally a **resource** and returns an [**authorization object**](/concepts/authorization-object), either granted or denied.
