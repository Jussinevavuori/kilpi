...
Plugins are used to extend the functionality of Kilpi. They are implemented using the same public [hooks APIs](/docs/docs/concepts/hooks) as available to you.
