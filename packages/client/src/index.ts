 ...
 */
export type KilpiClientSideClient<TKilpiServerClient extends KilpiServerClient<any, any>> =
  ReturnType<typeof createKilpiClientSideClient<TKilpiServerClient>>;

/**
 * Create a server client.
 */
export function createKilpiClientSideClient<TKilpiServerClient extends KilpiServerClient<any, any>>(
  ...
  // Extract types
  type TSubject = TKilpiServerClient["$$types"]["subject"];
  type TRuleset = TKilpiServerClient["$$types"]["ruleset"];
  ...
  async function getPermission<TKey extends RulesetKeys<TRuleset>>(
    ...
    type PermissionResult = Permission<InferRuleSubjectNarrowed<GetRuleByKey<TRuleset, TKey>>>;
    try {
      // Attempt cache hit
  ...
  return {
    ...
    // Pass types through
    $$types: {} as TKilpiServerClient["$$types"],
  };
}
