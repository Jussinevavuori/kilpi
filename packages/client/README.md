...
## The `@kilpi/client` package.

It contains the client-side SDK for Kilpi and should be used with [`@kilpi/core`](https://www.npmjs.com/package/@kilpi/core) to build authorization into your frontend applications.
