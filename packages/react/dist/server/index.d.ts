...
export type InferRuleSubjectNarrowed<T> = InferRule$1<T>["subjectNarrowed"];
type DeepObject$1<T> = {
 ...
 */
export type RulesetKeys<TRuleset extends Ruleset$1<any>> = RecursiveKeysTo$1<TRuleset, TRuleset extends Ruleset$1<infer TSubject> ? Rule$1<any, TSubject> : never, typeof RULE_KEY_SEPARATOR>;
type EnsureTypeIsRule$1<T> = T extends Rule$1<any, any, any> ? T : never;
/**
 * Type of a rule from a ruleset given a key.
 */
export type GetRuleByKey<TRuleset extends Ruleset$1<any>, TKey extends RulesetKeys<TRuleset>> = EnsureTypeIsRule$1<RecursiveValueByKey$1<TRuleset, TKey, typeof RULE_KEY_SEPARATOR>>;
 ...
 */
export type GetPermissionReturn<TSubject extends object | null | undefined, TRuleset extends Ruleset$1<TSubject>, TRulekey extends RulesetKeys<TRuleset>> = Promise<Permission$1<InferRuleSubjectNarrowed<GetRuleByKey<TRuleset, TRulekey>>>>;
/**
 ...
 */
export type ProtectReturn<TSubject extends object | null | undefined, TRuleset extends Ruleset$1<TSubject>, TRulekey extends RulesetKeys<TRuleset>> = Promise<InferRuleSubjectNarrowed<GetRuleByKey<TRuleset, TRulekey>>>;
/**
 ...
 */
export declare function createKilpiReactServerComponents<TSubject extends object | undefined | null, TRuleset extends Ruleset<TSubject>>(Kilpi: KilpiServerClient<TSubject, TRuleset>, options: CreateReactServerComponentOptions): {
	Access: <TRulekey extends RecursiveKeysTo<TRuleset, TRuleset extends Ruleset<infer TSubject_1> ? Rule<any, TSubject_1, TSubject_1> : never, ":">>(props: {
