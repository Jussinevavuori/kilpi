...
declare function Grant<TSubjectOut>(subject: TSubjectOut): PermissionGrant$1<TSubjectOut>;
declare function Deny(message?: string): PermissionDeny$1;
...
export type InferRuleGuardedSubject<T> = InferRule$1<T>["guardedSubject"];
...
export type KilpiConstructor<TSubject extends object | null | undefined> = {
	...
	guard: <TGuardedSubject extends object | null | undefined>(guard: SubjectGuard$1<TSubject, TGuardedSubject>) => SubjectGuard$1<TSubject, TGuardedSubject> & {
		 ...
		 */
		create: <TResource>(check: (subject: TGuardedSubject, resource: TResource) => MaybePromise<boolean | Permission$1<TGuardedSubject>>) => Rule$1<TResource | TResource[], TSubject, TGuardedSubject>;
	};
	/**
	 * Create Rule without guard (equal to creating with trivial guard)
	 */
	create: <TResource>(check: (subject: TSubject, resource: TResource) => MaybePromise<boolean | Permission$1<TSubject>>) => Rule$1<TResource | TResource[], TSubject, TSubject>;
};
/**
...
declare class KilpiCore<TSubject extends object | null | undefined, TRuleset extends Ruleset$1<TSubject>, TGuards extends Record<string, SubjectGuard$1<TSubject, object | null | undefined>>> {
	/**
	 * Subject fetcher
	 */
	 ...
	 */
	getPermission<TKey extends RulesetKeys$1<TRuleset>>(key: TKey, resource: InferRuleResource$1<GetRuleByKey$1<TRuleset, TKey>>): Promise<Permission$1<InferRuleGuardedSubject<GetRuleByKey$1<TRuleset, TKey>>>>;
	/**
	 ...
	 */
	protect<TKey extends RulesetKeys$1<TRuleset>>(key: TKey, resource: InferRuleResource$1<GetRuleByKey$1<TRuleset, TKey>>, onDeny?: OnDenyHandler): Promise<InferRuleGuardedSubject<GetRuleByKey$1<TRuleset, TKey>>>;
	/**
 ...
 * Access props
 */
export type AccessProps<TCore extends KilpiCore<any, any, any>, TKey extends RulesetKeys<TCore["ruleset"]>> = {
	/**
	 * Rule key to access.
	 */
	key: TKey;
 ...
 */
export declare function createKilpiReactServerComponents<TCore extends KilpiCore<any, any, any>>(KilpiCore: TCore, options: CreateReactServerComponentOptions): {
	Access: <TKey extends RulesetKeys<TCore["ruleset"]>>(props: AccessProps<TCore, TKey>) => React$1.JSX.Element;
};
