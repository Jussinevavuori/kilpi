...
See [project structure](/docs/getting-started/project-structure) for more information on how to structure your project when splitting policies into multiple files.
