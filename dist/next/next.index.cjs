...
// src/next/next.index.ts
var exports_next_index = {};
__export(exports_next_index, {
  createNextKilpiPlugin: () => createNextKilpiPlugin
});
module.exports = __toCommonJS(exports_next_index);
...
// src/next/next.index.ts
var getPerRequestOnProtectCache = import_react.cache(() => ({
  onProtect: undefined
}));
function createNextKilpiPlugin(options) {
  return createPlugin({
    pluginName: "next",
    wrapProtectedQuery: options.disableWrapQueryInReactCache ? undefined : import_react.cache,
    onProtect: {
      set(onProtect) {
