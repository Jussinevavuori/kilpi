...
3.  ### Create your subject
    ...
    This function will automatically be called (and [cached](/concepts/subject#subject-caching)) by Kilpi while authorizing.
...
-	Read up on [Kilpi concepts and guides](/concepts/authorization-object).
