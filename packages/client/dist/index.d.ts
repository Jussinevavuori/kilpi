...
declare function getRuleConstructors<TSubject extends object | null | undefined, TNarrowedSubject extends object | null | undefined = TSubject>(): {
	create: <TResource>(check: (subject: TSubject, resource: TResource) => MaybePromise<boolean | Permission$1<TSubject>>) => Rule$1<TResource | TResource[], TSubject>;
	subject: <TSubjectNarrowed>(getNarrowedSubject: (subject: TSubject) => false | TSubjectNarrowed) => {
		 ...
		 */
		create<TResource_1>(check: (subject: TSubjectNarrowed, resource: TResource_1) => MaybePromise<boolean | Permission$1<TSubjectNarrowed>>): Rule$1<TResource_1 | TResource_1[], TSubject, TSubjectNarrowed>;
	};
};
