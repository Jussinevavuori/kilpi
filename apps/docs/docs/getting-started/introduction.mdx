...
- **Declarative**
  ...
  All Kilpi APIs are designed to be declarative, from [Policies](/docs/concepts/policy) to [Protected Queries](/docs/concepts/protected-query) making for a simpler authorization model.
