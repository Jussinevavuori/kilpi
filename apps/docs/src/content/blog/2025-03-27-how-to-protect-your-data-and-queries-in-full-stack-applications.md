...
Creating a protected query is simple with [Kilpi.query](https://kilpi.vercel.app/concepts/protected-query), but you can also implement a similar pattern on your own.
